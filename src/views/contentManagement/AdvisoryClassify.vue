<template>
  <div class="container">
    ...
    <el-table v-loading="listLoading" :data="tableData" border style="width: 100%">
      ...
      <el-table-column prop="id" label="表ID" align="center" />
      <el-table-column prop="title" label="资讯分类" align="center" />
    ...
    <el-dialog :title="dialogTitle" :visible.sync="isShowAdd" width="500px">
      <el-form ref="articalForm" :model="articalForm" :rules="rules">
        <el-form-item label="资讯分类名称：" prop="title" :label-width="formLabelWidth">
